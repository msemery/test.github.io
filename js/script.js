...
require('./script.js');
require('./parallax_mouse.js');

},{"./parallax_mouse.js":328,"./script.js":329,"babel-polyfill":1}],328:[function(require,module,exports){
"use strict";
...
var Parallax = function () {
    ...
    _createClass(Parallax, [{
        ...
        key: "parseElementsOptions",
        value: function parseElementsOptions(elements) {
            var elementsArray = Array.from(elements);
            this.elements = elementsArray.map(function (el) {
                return {
                    DOMElement: el,
                    options: {
        ...
        key: "setContainersCSS",
        value: function setContainersCSS() {
            this.containers.forEach(function (container) {
                var position = window.getComputedStyle(container, null).position;
        ...
        key: "setElementsCSS",
        value: function setElementsCSS() {
            this.elements.forEach(function (element) {
                var el = element.DOMElement,
        ...
        value: function setListeners() {
            ...
            document.body.addEventListener('mousemove', function (e) {
                return _this.mouseParallax(e);
            });
            document.body.addEventListener('scroll', this.scrollParallax);
        }
    }, {
        key: "mouseParallax",
        value: function mouseParallax(e) {
            var _this2 = this;
            ...
            var mouseX = e.clientX,
                ...
                mouseElements = this.elements.filter(function (el) {
                return el.options.eventType === "mouseX" || el.options.eventType === "mouseY";
            });

            mouseElements.forEach(function (element) {
                var el = element.DOMElement,
                    opts = element.options;
                if (opts.transformType == "translate") {
                    _this2.applyTranslation(el, opts, xPercentage, yPercentage);
                } else if (opts.transformType == "rotate") {
                    _this2.applyRotation(el, opts, xPercentage, yPercentage);
                }
            });
        }
    }, {
        key: "scrollParallax",
        value: function scrollParallax(e) {}
    }, {
        key: "applyTranslation",
        value: function applyTranslation(el, opts, xPercentage, yPercentage) {
            var translatePercentage = void 0;
        ...
        key: "applyRotation",
        value: function applyRotation(el, opts, xPercentage, yPercentage) {
